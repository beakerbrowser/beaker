...
-- remove deprecations
DROP TRIGGER crawl_discussions_au;
DROP TRIGGER crawl_discussions_ad;
DROP TRIGGER crawl_discussions_ai;
DROP TRIGGER crawl_media_au;
DROP TRIGGER crawl_media_ad;
DROP TRIGGER crawl_media_ai;
DROP TRIGGER crawl_site_descriptions_au;
DROP TRIGGER crawl_site_descriptions_ad;
DROP TRIGGER crawl_site_descriptions_ai;
DROP TRIGGER crawl_dats_au;
DROP TRIGGER crawl_dats_ad;
DROP TRIGGER crawl_dats_ai;
DROP TRIGGER crawl_bookmarks_au;
DROP TRIGGER crawl_bookmarks_ad;
DROP TRIGGER crawl_bookmarks_ai;
DROP TRIGGER crawl_comments_au;
DROP TRIGGER crawl_comments_ad;
DROP TRIGGER crawl_comments_ai;
DROP TRIGGER crawl_statuses_au;
DROP TRIGGER crawl_statuses_ad;
DROP TRIGGER crawl_statuses_ai;
