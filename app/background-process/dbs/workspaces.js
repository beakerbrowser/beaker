...
export async function getUnusedName (baseName) {
  ...
  throw new Error('Failed to find an unused name... that really doesnt seem like it should possible but here we are')
}
