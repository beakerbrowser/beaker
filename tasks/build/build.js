...
var bundleApplication = function () {
  ...
  return Q.all([
    ...
    bundle(srcDir.path('markdown-renderer.js'),        srcDir.path('markdown-renderer.build.js'), { browserify: true, basedir: srcDir.cwd() }),
    ...
    bundle(bpViewsDir.path('timeline.js'),             bpBuildDir.path('timeline.build.js'), { browserify: true, basedir: bpViewsDir.cwd() }),
    bundle(bpViewsDir.path('search.js'),               bpBuildDir.path('search.build.js'), { browserify: true, basedir: bpViewsDir.cwd() }),
